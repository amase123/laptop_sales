...
def submit():
    ...
    if make == "mac":
        ...
        if model == "envy":
            ...
            messagebox.showinfo("Laptop Sales Tech", "Mr/Mrs "+name+", you have selected HP Elitebook, the cost is $800")
        elif model == "pavilion":
            messagebox.showinfo("Laptop Sales Tech", "Mr/Mrs "+name+", you have selected pavilion, the cost is $800")
    elif make == "Dell":
        if model == "xps17":
            messagebox.showinfo("Laptop Sales Tech", "Mr/Mrs "+name+", you have selected Dell xps17, the cost is $500")
        elif model == "inspion":
            messagebox.showinfo("Laptop Sales Tech", "Mr/Mrs "+name+", you have selected Dell inspion, the cost is $6600")
        elif model == "latitude":
            messagebox.showinfo("Laptop Sales Tech", "Mr/Mrs "+name+", you have selected Dell latitude, the cost is $800")
...
model_option = tk.OptionMenu(root, model_var, "macbook air", "macbook pro", "macbook air m1", "envy", "elitebook", "pavilion", "xps17", "inspion", "latitude")
